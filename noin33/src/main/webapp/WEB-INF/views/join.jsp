...
<html lang="en">
  ...
  <body>
	...
	<div align="center">
		<h1>회원가입 </h1>
		<input type="text" placeholder="Email을 입력하세요"> <br><br>
		<input type="text" placeholder="password를 입력하세요"> <br><br>
		<input type="text" placeholder="이름을 입력하세요"> <br><br>
		<input type="text" placeholder="전화번호를 입력하세요."> <br><br>
		<input type="text" placeholder="주소를 입력하세요"> <br><br>
		<input type="text" placeholder="자격증, 경력을 입력하세요"> <br><br>
		<div id="btn_group"> <button id="test_btn1">회원가입</button> <button id="test_btn2">메인으로</button> </div>
	</div> <br><br>
