  ...
  <body>
    ...
    <!-- END nav -->
        <section class="ftco-section bg-light">
			<div class="container">
        <div>
        	<h1 align="center">광주 경로당&공원 찾기</h1> <br>
        </div>
				<div class="row justify-content-center">
		    <div id= "message">원하시는 경로당에 신청하시면 복지사에게 메세지가 갑니다. </div>
		<div id="mapwrap"> 
		    <!-- 지도가 표시될 div -->
...
var array = [['지산 1동','광주광역시 동구 지산1동','062-228-1741','나들이','무료','20'],
	['산수2동경로당','광주광역시 동구 산수동','062-263-2710','자조모임','무료','20'],
	['정암경로당','광주광역시 동구 산수1동','062-223-1838','난타교실','무료','10'],
	['만승경로당','광주광역시 동구 계림동','062-223-6366','한지공예','무료','15'],
	['삼성경로당','광주광역시 동구 호남동','062-225-3565','노래교실','무료','20'],
	['양림오거리 경로당','광주광역시 남구 양림동','N/A','화초키우기','무료','10'],
	['양림2휴먼시아경로당','광주광역시 남구 양림동','062-654-9090','요리교실','무료','15'],
	['숙실 경로당','광주광역시 동구 학동','062-227-4632','문화체험','무료','20'],
	['석천경로당','광주광역시 동구 소태동 512-11','062-226-4564','건강체조','무료','20'],
	['봉선모아1단지2차경로당','광주광역시 남구 봉선동 984','062-653-1616','피아노교실','무료','10'],
	['남관경로당','광주광역시 남구 백운동 614-19','062-232-0339','국안반','무료','15'],
	['라인하이츠경로당','광주광역시 남구 봉선동 988','062 -654-7177','한글반','무료','20'],
	['주월동명지맨션경로당','광주광역시 남구 주월동 700','062-363-9346','미술치료','무료','10'],
	['남구거점경로당','광주광역시 남구 주월동 472','062-672-5080','원예치료','무료','15'],
	['신천경로당','광주광역시 남구 주월동 1240-1','062-654-8333','화초키우기','무료','20'],
	['광진경로당','광주광역시 남구 진월동 320-3','062-651-6114','나들이','무료','15']
	]
...
'           </div>' + 
'            <div>' + 
'                <div ">'+'주소 : '+array[i][1] + '<br>'+'연락처: '+array[i][2]+'<br>'+'진행중인 행사 : '+array[i][3]+'  이용비: '+array[i][4]+'<br>'+'수용인원 : '+array[i][5]+'       '+'<button id="btn-together">'+
'신청</button>'+'</div>'
