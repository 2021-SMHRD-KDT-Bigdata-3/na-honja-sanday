...
update welfare_worker set certi= '사회복지사 1급 / 작업치료사' where name ='헬로키티';
...
update welfare_worker set certi= '간호조무사 / 사회복지사 2급 / 물리치료사' where name ='정태히';
update welfare_worker set certi= '요양보호사 / 사회복지사 1급 / 작업치료사' where name ='정태이';
